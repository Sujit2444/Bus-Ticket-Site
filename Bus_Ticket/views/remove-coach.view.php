...
<li class="dropdown">
 ...
 <div class="topnav-rightLogout">
   ...
   <h2><font size="6">Select One Coach Number :</font></h2>
   <form method="POST" action="/Bus_Ticket/postRemoveCoach">

  <?php foreach ($messages['coach'] as $message):?> 
 <label class="container"><?= $message->getCoachNo(); ?>
...
<h1 style="color: green" > <?=$messages['flag'] ;?></h1>
