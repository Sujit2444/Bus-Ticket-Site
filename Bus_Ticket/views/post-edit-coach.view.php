...
<div class="bodyborder">
  ...
  <div style="padding-left:20%">
   <h2><font size="6">Coach No:</font></h2>

  <form method="POST" action="/Bus_Ticket/postEditCoach">
    
    <input type="text" name="coachNo" placeholder="Enter Coach Number..." value=<?=$messages['selectCoach'];?>  >
