...
<li class="dropdown">
 ...
 <div style="padding-left:20%">
   <h2><font size="6">Coaches:</font></h2>
 <table>
  <tr>
    <th>Coach Number:</th>
  </tr>
  <?php 
   //dd($messages);
   foreach ($messages['allCoach'] as $message) :?>
   <tr>
   	<td> <?=$message->getCoachNo();?></td>
 ...
 <?php endforeach?>
  ...
  <form method="POST" action="/Bus_Ticket/postAddCoach">
    <label for="fname">Coach Number:</label></br>
    <input type="text" name="coachNo" placeholder="Enter Coach No...">
