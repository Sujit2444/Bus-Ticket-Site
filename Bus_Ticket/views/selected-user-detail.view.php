...
<li class="dropdown">
 ...
 <div class="topnav-rightLogout">
   ...
   <h2><font size="6">User Details:</h2>
   
    <p style="color:DeepSkyBlue;"><font size="6">
    First Name:<?=$messages[0]->getFirstName()?></br>
    Last Name:<?=$messages[0]->getLastName()?></br>
    Email:<?=$messages[0]->getEmail()?></br>
