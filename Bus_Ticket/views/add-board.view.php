...
<li class="dropdown">
 ...
 <div style="padding-left:20%">
   <h2><font size="6">Boarding Points:</font></h2>
 <table>
  <tr>
    <th>Boarding Point Name</th>
  </tr>
  <?php 
   //dd($messages);
   foreach ($messages['allBoard'] as $message) :?>
   <tr>
   	<td> <?=$message->getBoardingPointName();?></td>
 ...
 <?php endforeach?>
  ...
  <form method="POST" action="/Bus_Ticket/postAddBoard">
    <label for="fname">Boarding Point Name:</label></br>
    <input type="text" name="boardName" placeholder="Enter Boarding Point Name...">
    
    <input type="submit" value="Submit">
  </form>
   <h1 style="color: red" > <?=$messages['flagError'] ;?></h1> 
   <h1 style="color: green" > <?=$messages['flagComplete'] ;?></h1>
  </div>
