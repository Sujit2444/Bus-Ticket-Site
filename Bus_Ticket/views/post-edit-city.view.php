...
<div class="bodyborder">
  ...
  <div style="padding-left:20%">
   <h2><font size="6">City Name:</font></h2>

  <form method="POST" action="/Bus_Ticket/postEditCity">
    
    <input type="text" name="cityName" placeholder="Enter City Name..." value=<?=$messages['selectCity'];?>  >
